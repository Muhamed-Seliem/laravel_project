 ...
 <div class="card my-4">
  <div class="card-header">
   ...
   <div class="card-body">
     <div class="row">
       <div class="col-md-4">
       <img width="100%" height="200px" src="https://img.freepik.com/free-photo/e-learning-online-digital-age-knowledge-education-training-seminar-personal-development_113717-127.jpg?w=826" class="card-img-top" alt="...">
