            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- to get an API token!-->
                        <form id="contactForm" action="{{route('handleregister')}}" method="post" enctype="multipart/form-data" data-sb-form-api-token="API_TOKEN">
                           @csrf                            <!-- Name input-->
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" name="password"   type="password" placeholder="(123) 456-7890" data-sb-validations="required" />
